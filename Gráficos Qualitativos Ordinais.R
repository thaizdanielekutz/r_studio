...
#Gráfico de colunas ou barras verticais empilhadas com frequência relativa
grafico_coluna_empilhada=ggplot(variaveis_categoricas_ordinais, aes(x=a_classe_social,fill=a_grau_instrucao))+
...
grafico_coluna_porcent_por_grau_instrucao=ggplot(variaveis_categoricas_ordinais, aes(x=a_classe_social, fill=a_grau_instrucao))+
